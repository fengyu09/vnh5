<template>
  <div class="memberReport" :class="$st.state.skin==5?'report-golden':''">
     <headerExtend/>
     <div class="re-header" >
       <i :class="[{'skin-btn-pink':$st.state.skin==1},{'skin-btn-blue':$st.state.skin==2},{'skin-btn-green':$st.state.skin==3},{'skin-btn-maingreen':$st.state.skin==4},{'skin-btn-golden':$st.state.skin==5}]">{{$t('memberReport[1]')}}</i>
       <ul class="clearfix">
         <li>
           <span class="re-shuliang">{{lastMsg.invitee_num}}</span>
           <span class="huiColor">{{$t('memberReport[2]')}}</span>
         </li>
         <li>
           <span class="re-shuliang"> {{lastMsg.recharge}}</span>
           <span class="huiColor">{{$t('memberReport[3]')}}</span>
         </li>
         <li>
            <span class="re-shuliang">{{lastMsg.brokerage}}</span>
            <span class="huiColor">{{$t('memberReport[4]')}}</span>
         </li>
       </ul>
     </div>
     <myScroll
           ...
           <ul v-if="reportList.length>0">
             <li v-for="(v,index) in reportList" :key="index">
               <div class="clearfix re-info">
                 ...
                 <span class="fr">
                   <i class="huiColor">{{$t('memberReport[5]')}}</i>
               ...
               <div class="clearfix num-cont">
                 <span>
                   <i class="huiColor">{{$t('memberReport[6]')}}</i>
                   <i class="re-shuliang1">{{v.recharge}}</i>
                 </span>
               
                 <span>
                   <i class="huiColor">{{$t('memberReport[7]')}}</i>
