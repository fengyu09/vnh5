<template >
  <div class="system">
    <flexbox class="infoHead">
      ...
      <flexbox-item>
        <div class="flex-demo tickling">系统消息</div>
      </flexbox-item>
      <flexbox-item :span="1 / 10">
      ...
      <div style="margin: 0 4%;">
        <ul>
          <li v-for="(item,index) in noticeList" :key="index">
            <div class="gf-time">
              <span>{{item.create_time | formatDate1}}</span>
            </div>
            <div class="clearfix">
              <div class="gf-img fl">
                <img src="../../assets/images/member/messXitong-min.png" alt />
              </div>
              <div class="fl gf-nr">
                <div class="gf-tit">
                  <div class="gf-tit-1" v-html="item.content"></div>
                  <!-- <div class="gf-mess">
                    <ul>
                      <li>1 . 增加加加加加加加加加加加加加加</li>
                      <li>2 . 加加加加加加加加加加加加加加</li>
                      <li>3 . 加加加加加加加加加加加加加加</li>
                    </ul>
                  </div> -->
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...mapMutations(["SETXTNOTICES"]),
    init() {
      this.getNoticeList();
      this.SETXTNOTICES('non')
    },
    getNoticeList() {
      this.noticeList = JSON.parse(this.systemData);
    }
  }
};
</script>
