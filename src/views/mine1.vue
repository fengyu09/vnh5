    ...
    <div class="mine2-container" id="mine2-container">
        <myScroll :top="0" :bottom="1.4" :bgColor="'f5f7fa'" ref="scrollWrapper">
            <div class="session session-header" v-show="codeToken">
                ...
                <div class="user-mess">
                    <div class="user-name" :class="[{'sx-pink':skin ==1},{'sx-blue':skin ==2},{'sx-green':skin ==3},{'sx-maingreen':skin ==4}]">
                    ...
                    <div class="user-id">
                        ...
                        <p class="user-money"  :class="[{'sx-pink':skin ==1},{'sx-blue':skin ==2},{'sx-green':skin ==3},{'sx-maingreen':skin ==4}]">{{$t('member.text[2]')}}{{amount}} {{$t('moneyDw')}} <i v-if="lanCode!=2" class="yw-icon" :class="[{'yw-pink':skin == 1},{'yw-blue':skin == 2},{'yw-green':skin == 3},{'yw-maingreen':skin == 4}]" @click="showBl"></i> <i class="backMoney" @click="hsMoney">{{$t('member.text[3]')}}</i></p>
            ...
            <div class="session session-header no-session-header" v-show="!codeToken">
                <div class="login-reg-btn" :class="[{'login-reg-btn-pink':skin ==1},{'login-reg-btn-blue':skin ==2},{'login-reg-btn-green':skin ==3},{'login-reg-btn-maingreen':skin ==4}]"><router-link to='login'>{{$t('loginText')}} </router-link>&nbsp;/&nbsp;<router-link :to="noticeType==1?'register':'RegisterDl'">{{$t('registerText')}}</router-link></div>
            ...
            <div class="session session-main-server">
                ...
                <ul :class="[{'go-pink':skin==1},{'go-blue':skin==2},{'go-green':skin==3},{'go-maingreen':skin==4}]">
                  <li>
                    <i class="go-icon5">
      ...
      <myScroll ref="scrollWrapper2" :top='2' :bottom='5'>
          <div class="call-back-content">
            ...
            <div class="back-item fk-item" >
              ...
              <div class="item-list"  style="margin-bottom:0" :class="[{'skin-item-pink':skin ==1},{'skin-item-blue':skin ==2},{'skin-item-green':skin ==3},{'skin-item-maingreen':skin ==4}]">
            ...
            <div class="back-item">
              ...
              <div class="item-list lan-item" :class="[{'skin-item-pink':skin ==1},{'skin-item-blue':skin ==2},{'skin-item-green':skin ==3},{'skin-item-maingreen':skin ==4}]">
               
                <span v-for="(v,index) in lanList" :key="index"  
                 :class="[{'active':$st.state.skin ==0&&v.is_check},{'skin-btn-pink':$st.state.skin ==1&&v.is_check},{'skin-btn-blue':$st.state.skin ==2&&v.is_check},{'skin-btn-green':$st.state.skin ==3&&v.is_check},{'skin-btn-maingreen':$st.state.skin ==4&&v.is_check}]"
                 @click="changeLan($event,v,$st.state.skin)">{{v.title}}</span>
              </div>
            </div>
            <div class="back-item">
              <span style="display:block;margin-bottom:2%">{{$t('member.text[25]')}}</span>
              <input type="text" maxlength="11" :class="[{'skin-border-pink':skin ==1},{'skin-border-blue':skin ==2},{'skin-border-green':skin ==3},{'skin-border-maingreen':skin ==4}]"  onkeyup="this.value=this.value.replace(/[^\d]/g,'')" v-model="memberAccount" :placeholder="$t('member.text[26]')">
            </div>
            <div class="back-item">
              <span style="display:block;margin-bottom:2%;margin-top:2%">{{$t('member.text[27]')}}</span>
              <input type="text" :class="[{'skin-border-pink':skin ==1},{'skin-border-blue':skin ==2},{'skin-border-green':skin ==3},{'skin-border-maingreen':skin ==4}]" maxlength="12"  onkeyup="this.value=this.value.replace(/[^\d]/g,'')" v-model="tel" :placeholder="$t('member.text[28]')">
            </div>
            <div class="commit-btn" :class="[{'skin-btn-pink':skin ==1},{'skin-btn-blue':skin ==2},{'skin-btn-green':skin ==3},{'skin-btn-maingreen':skin ==4}]"  @click="getCallBack">{{$t('member.text[29]')}}</div>
          </div>
