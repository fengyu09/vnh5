<template>
    <div class="chat-box" id="chatBox" :class="hp?'hp':''" >
        <div class="chat-header">
            ...
            <div class="fr down-load" @click="download">打开APP</div>
        </div>
        <div class="live-room" >
            ...
            <div class="video-wrap">
                ...
                <div class="video-box" v-if="!isHideVideo"  >
                    <div >
                        <div v-if="liveData&&liveData.live_status" >
                            ...
                            <flv-player src="http://tp1.liveplay.vk7b0.cn/live/efd1a2f9b0b5f14b1fac70a7f8e8a9e7.flv?user=test5&pass=123456" v-if="!isiOS&&$route.params.id==100188" :imgSrc="liveData" :chatData="chatData" :pushDanmu="pushDanmu" @watchChild="watchChild"/>

                            <flv-player src="http://tp1.liveplay.vk7b0.cn/live/24a300ac71124eac458c7b22a8903fc2.flv?user=lgzb131&pass=123456" v-if="!isiOS&&$route.params.id==100189" :imgSrc="liveData" :chatData="chatData" :pushDanmu="pushDanmu" @watchChild="watchChild"/>

                            <flv-player src="http://tp1.liveplay.vk7b0.cn/live/127ba3f4091df4a210b45e5e781b3b82.flv?user=lgzb137&pass=123456" v-if="!isiOS&&$route.params.id==100191" :imgSrc="liveData" :chatData="chatData" :pushDanmu="pushDanmu" @watchChild="watchChild"/>

                             <flv-player src="http://tp1.liveplay.vk7b0.cn/live/b6e0a198de15835a1c344bf362d978da.flv?user=lgzb133&pass=123456" v-if="!isiOS&&$route.params.id==100190" :imgSrc="liveData" :chatData="chatData" :pushDanmu="pushDanmu" @watchChild="watchChild"/>

                             <flv-player src="http://tp1.liveplay.vk7b0.cn/live/9efa95402e30e262a1db287b33f67c41.flv?user=lgzb244&pass=123456" v-if="!isiOS&&$route.params.id==100047" :imgSrc="liveData" :chatData="chatData" :pushDanmu="pushDanmu" @watchChild="watchChild"/>

                            

                            
                             <hls-player src="http://tp1.liveplay.vk7b0.cn/live/efd1a2f9b0b5f14b1fac70a7f8e8a9e7.m3u8?user=test5&pass=123456" v-if="isiOS&&$route.params.id==100188" :imgSrc="liveData"  :chatData="chatData" />
                             <hls-player src="http://tp1.liveplay.vk7b0.cn/live/24a300ac71124eac458c7b22a8903fc2.m3u8?user=lgzb131&pass=123456" v-if="isiOS&&$route.params.id==100189" :imgSrc="liveData"  :chatData="chatData" />
                             <hls-player src="http://tp1.liveplay.vk7b0.cn/live/127ba3f4091df4a210b45e5e781b3b82.m3u8?user=lgzb137&pass=123456" v-if="isiOS&&$route.params.id==100191" :imgSrc="liveData"  :chatData="chatData" />
                              <hls-player src="http://tp1.liveplay.vk7b0.cn/live/b6e0a198de15835a1c344bf362d978da.m3u8?user=lgzb133&pass=123456" v-if="isiOS&&$route.params.id==100190" :imgSrc="liveData"  :chatData="chatData" />
                               <hls-player src="http://tp1.liveplay.vk7b0.cn/live/9efa95402e30e262a1db287b33f67c41.m3u8?user=lgzb244&pass=123456" v-if="isiOS&&$route.params.id==100047" :imgSrc="liveData"  :chatData="chatData" />
                ...
                <div class="room-info-tab" v-if="!guessSw" :class="isHideVideo?'hideVideoTab':''">
                    <ul class="fl room-tab">
                        <li @click="currTab=1" :class="currTab==1?'active':''"><span>聊天</span></li>
...
<!--                        </span>-->
                    <!--聊天内容-->
                    <myScroll v-show="currTab==1&&!guessSw"  ref="scrollWrapper" :data="playList" :class="isHideVideo?'high-index':''" :top="isHideVideo?3.1:8.6" :bottom="showEmj?4:1.2"  class="scrollWrapper" >
...
<!--                                </span>-->
                    ...
                    <myScroll v-show="currTab==2"  ref="scrollWrapper2" :data="playList" :class="isHideVideo?'high-index':''" :top="isHideVideo?2.3:7.85" :bottom="0"   class="scrollWrapper" >
                        <!--主播个人信息-->
                    ...
                    <myScroll v-show="currTab==3"  ref="scrollWrapper3" :data="playList" :class="isHideVideo?'high-index':''" :top="isHideVideo?2.3:7.85"  :bottom="0"   class="scrollWrapper" >
                        <!--排行-->
                    ...
                    <myScroll v-show="currTab==4"  ref="scrollWrapper4" :data="playList" :class="isHideVideo?'high-index':''" :top="isHideVideo?2.3:7.85"  :bottom="0"   class="scrollWrapper" >
                        <!--预告-->
        ...
        <div class="vip-container">
            <div class="vip-in" v-show="vipIsShow">
        ...
        <div class="chat-footer" v-show="isHide==false&&liveData&&!isShowKey &&currTab==1 && !guessSw" :style="{bottom:ftBottom+'rem'}">
        ...
        <div class="chat-footer key" v-show="isHide==false&&isShowKey" :style="{bottom:ftBottom+'rem'}">
            <div class="send-barrage-view">
                <div @focusout="inputBlur" @focusin="inputFocus">
                  ...
                  >
                    ...
                    <img src="../../assets/images/chat/smiley.png" alt="" @click="changeEmg" v-show="!showEmj">
                    <img src="../../assets/images/chat/keyboard-icon.png" alt="" @click="changeEmg2();showEmj=false" v-show="showEmj" style="width:0.6rem;top:0.1rem">
                </div>
                <!-- <keep-alive>
        ...
        <div class="footChat" v-if="isHide==true">未开播禁止发言</div>
        ...
        <div class="git-list-box" v-if="show4">
            ...
            <div class="git-content">
                <myScroll  ref="scrollWrapperX" :data="playList" :bottom="1.25" :top="1.3">
                    <div class="clearfix" v-for="(tab,key) in giftTab" v-show="tab==currGitType && giftData[currGitType].length">
                    ...
                    <div v-show="!giftData[currGitType].length">
                        暂无
                    </div>
                </myScroll>
            </div>
            <div class="git-bottom">
                ...
                <div class="fr send-container clearfix">
                    <span class="select-num fl" @click="showDiamondNum=!showDiamondNum" v-show="selectnumShow">{{giftFormData.gift_num}} <img src="../../assets/images/chat/num-icon.png" alt=""></span>
        ...
        <!-- 送红包弹窗-->
        <div class="git-list-box-bg" v-show="showR" @click="showR=!showR"></div>
        <div class="send-red-box" v-show="showR" @focusout="inputBlur" @focusin="inputFocus">
        ...
        <keep-alive>
            <!-- &&isShowKey -->
            <vme v-show="showEmj&&isShowKey" ref="vmeChild" :showEmoji="showEmj" style="bottom:0"></vme>
        ...
        <div class="dialog-pop send-gift-pop" v-if="sendGiftPop">
            ...
            <div class="dialog_no_longer" v-if="isShowImg!='true'">
                <img src="../../assets/images/chat/wxzyh@3x.png" alt=""  @click="isShowImg=2" v-show="isShowImg==1">
                <img src="../../assets/images/chat/wxzyh@2x.png" alt=""  @click="isShowImg=1" v-show="isShowImg==2">
                <span>下次不再提示</span>
            </div>
    ...
    <p style="text-align:center;">Are you sure</p>
        ...
        <!--禁言弹窗-->
        <div class="no-speak" v-show="dialogShow">
...
<!--        </div>-->
        ...
        <!-- 大转盘入口 -->
        <div class="active-icon dzp-icon" @click="$router.push('/activityDaw')" v-show="currTab==1 && !guessSw" >
    ...
    export default {
        ...
        mounted() {
          ...
          document.getElementById('chatBox').addEventListener('click',function(e){
             ...
             let num2 = e.composedPath().findIndex(i=>i.className!=undefined&&i.className.includes('chat-footer'));
             if(num==-1&&num2==-1){
...
//                获取房间信息
            ...
            getLiveRoom() {
                ...
                this.$http.get(this.versionLive2+'live/get_live_room', {
                    params: {
                        anchor_id: this.$route.params.id,
                        user_id: this.$store.state.userinfo.user_id
                    }
