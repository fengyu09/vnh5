let filters = {
  ...
  filterBgColor(n) {
    let bg = ''
    if (n == '大') bg = 'bigbg'
    else if (n == '小') bg = 'smallbg'
    else if (n == '单') bg = 'oddbg'
    else if (n == '双') bg = 'evenbg'
  ...
  filgerBjl(arr) {
    ...
    if (z >= 8 || x >= 8 || (z >= 6 && x >= 6)) {} else if (x < 6) {
      x += four
      if (z <= 2) {
        z += six
      } else if (z == 3 && four != 8) {
  ...
  filterBs(a, num) {
    ...
    for (let k = 0, len = arr.length; k < len; k++) {
      ...
      // else if (arr.includes('9')&&arr.includes('0')) value = '半顺'
      else if (arr.length == 1) value = '豹子'
      else value = '杂六'
    }
    return value
  ...
  filterqsb(a) {
    ...
    let lv = 0 ;
    let value = '';
    let a0 = filters.filterHll1(a[0]);
    let a1 = filters.filterHll1(a[1]);
    let a2 = filters.filterHll1(a[2]);
    let a3 = filters.filterHll1(a[3]);
    let a4 = filters.filterHll1(a[4]);
    let a5 = filters.filterHll1(a[5]);
    let a6 = filters.filterHll1(a[6]);
    if(a0 == '蓝'){
      lan = lan- 0 + 1;
    }
    if(a0 == '绿'){
    ...
    // console.log(lv)
    // console.log('~~~~~~~~~~~~~~~~~~~~')
    if(lan == lv && hong == 1.5) return value = '和'
    if(lan == hong && lv == 1.5) return value = '和'
    if(hong == lv && lan == 1.5) return value = '和'
    if(lan > lv ){
      if(lan > hong) return value = '蓝'
      if(lan < hong) return value = '红'
    }else{
      if(lv > hong) return value ='绿'
      if(lv < hong) return value ='红'
    }
  ...
  filterOnlineNum(n,flag) {
    if (n > 10000) {
      if(flag) return (n / 10000).toFixed(2)+ "万" ;
      else return (n / 10000).toFixed(2)+ "万" ;
    }else if(!n){
      return 0
    }
    return n;
